#!/usr/bin/env python3
"""
File Stream Bot - HTTP Downloads
...
⚡ <i>By Zeus</i>"""
        ...
        kb = InlineKeyboardMarkup([[InlineKeyboardButton("📥 Download", url=dl_link)]])
...
@routes.get('/')
async def home(req):
    return web.Response(text="<h1>⚡ File Stream Bot by Zeus ⚡</h1>", content_type='text/html')
...
<head>
    ...
    <title>⚡ File Stream Bot - Download</title>
    <style>
...
<body>
    <div class="container">
        <div class="logo">⚡</div>
        <div class="brand">File Stream Bot</div>
...
async def stream_file(req):
    """Stream actual file from Telegram"""
    file_hash = req.match_info['file_hash']
...
━━━━━━━━━━━━
🔴 <i>File Stream Bot is Offline!</i>"""
